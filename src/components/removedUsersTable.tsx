...
// Componente para tabela de utilizadores desativados
const DisabledUsersTable = () => {
  ...
  // Procura os utilizadores desativados
  ...
  // Filtra os utilizadores pelo termo de pesquisa
  ...
  // Reativa um utilizador (atualiza estado para true)
