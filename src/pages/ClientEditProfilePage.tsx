...
const ClientEditProfile: React.FC = () => {
  ...
  // Bloqueia a UI enquanto o context não tiver valor
  if (!userId) return <div>A carregar utilizador...</div>;
    ...
    <div className="p-8">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4">
          <h2 className="text-2xl font-bold text-gray-800 m-0">Editar Perfil</h2>
          <div>
            {newProfileImage ? (
              <img
        ...
        <div className="p-8">
          ...
          >
            ...
            <div className="md:col-span-2">
              <label htmlFor="nome" className="block text-xs font-semibold text-gray-600 uppercase mb-2">
                Nome
              </label>
              <input
                id="nome"
            ...
            {/* NIF */}
            <div>
              <label htmlFor="nif" className="block text-xs font-semibold text-gray-600 uppercase mb-2">
                NIF
              </label>
              <input
                id="nif"
            ...
            {/* Data de Nascimento */}
            <div>
              <label htmlFor="dob" className="block text-xs font-semibold text-gray-600 uppercase mb-2">
                Data de Nascimento
              </label>
              <input
                id="dob"
            ...
            {/* Email */}
            <div>
              <label htmlFor="email" className="block text-xs font-semibold text-gray-600 uppercase mb-2">
                Email
              </label>
              <input
                id="email"
            ...
            {/* Concelho */}
            <div>
              <label htmlFor="concelho" className="block text-xs font-semibold text-gray-600 uppercase mb-2">
                Concelho
              </label>
              <input
                id="concelho"
            ...
            {/* Distrito */}
            <div>
              <label htmlFor="distrito" className="block text-xs font-semibold text-gray-600 uppercase mb-2">
                Distrito
              </label>
              <input
                id="distrito"
            ...
            {/* Código Postal */}
            <div>
              <label htmlFor="localidade" className="block text-xs font-semibold text-gray-600 uppercase mb-2">
                Código Postal
              </label>
              <input
                id="localidade"
